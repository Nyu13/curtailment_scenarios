# Import required libraries for file operations, data analysis, and statistical metrics
...
# Results DataFrame
df_results = pd.DataFrame(results, columns=['Turbine', 'Distance (km)', 'RMSE'])

# Save as CSV
output_path = MODEL_DIR / 'freq_plots' / 'rmse_distance_summary.csv'
df_results.to_csv(output_path, index=False)

print('✅ RMSE table saved:', output_path)
